      ...
      $resource('/db/sheduler').save(
        ...
        function (response) {
          ...
          if (response.response) {
            ...
            $scope.exporter = {
              "_id": "exporter", "enabled": false, "step": 120, "date": new Date(),
