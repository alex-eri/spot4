...
packages = ["rest","os","utils","struct","mschap","pytz","motor","aiohttp","asyncio","sms", "idna", "encodings","logging.handlers", 'utils.ServiceHandler','codecs', 'cachetools', 'setproctitle', 'uvloop'] #,"pandas"]
